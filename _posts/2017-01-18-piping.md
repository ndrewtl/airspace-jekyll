...
<b>Note : all the files you need to complete this tutorial can be downloaded from <a href="https://github.com/ourcodingclub/CC3-DataManip" target="_blank">this repository</a>.</b>

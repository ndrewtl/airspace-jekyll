...
#### <a href="#mixed"> 5. Plot results from mixed effects models </a>
...
Note how our figure only shows plot numbers 2, 4, 6. If we want to add the axis labels such that it labels every plot number, 1 - 6, you run the following code by using `breaks = c(1,2,3,4,5,6)` or using `breaks = 1:6`.

<a name="labs"></a>

## 2. Adding titles, subtitles, captions and axis labels // BEVERLY STOPPED HERE FOR NOW 

...
<b>Note : all the files you need to complete this tutorial can be downloaded from <a href="https://github.com/ourcodingclub/CC-4-Datavis">this repository</a>. Clone and download the repo as a zip file, then unzip it.</b>
...
In the code above you can see a colour code `colour="#8B5A00"` - each colour has a code, a combination of letters and numbers. To find out what is the code for a colour you like, click on `Addins/Colour picker`.

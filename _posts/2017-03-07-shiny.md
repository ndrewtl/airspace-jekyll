...
- <a href="https://johngodlee.shinyapps.io/LPI_example/" target="_blank">An app investigating the spatial distribution of records used to create the Living Planet Index</a> _Hint: You will need to use `verticalLayout()` for this one. See <a href="https://shiny.rstudio.com/gallery/vertical-layout.html" target="_blank">here for more info</a>_ 
<iframe src="https://johngodlee.shinyapps.io/LPI_example/" style="border:none;width:1000px;height:500px;"></iframe>

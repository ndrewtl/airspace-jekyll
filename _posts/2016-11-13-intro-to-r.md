...
<b>All of the files necessary to complete this tutorial are available to download from this <a href="">Github repository</a>. If you get stuck or feel unsure about something - you can download the full script, or get in touch with us - we are more than happy to answer questions at ourcodingclub@gmail.com !</b>

First, download the dataset (biodiv.csv) and open RStudio. Click on <i>File/New File/R script</i>. You will now see a window like this:
...
Now we can combine all those values in a vector, which is done using the c() function, and add labels with names().

...
<b>when working in R, you have a working directory (a certain folder on your computer) - that's where anything you save, such as plots will go. To find out where your working directory is now, run the code `getwd()`. If you want to change it, you can use `setwd()`, with your file path, e.g. <i>C:\User\R_Dreams in the brackets</i>.</b>

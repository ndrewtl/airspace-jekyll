...
The next few lines of code usually load the packages you are using for your analysis. A package is a bundle of commands that can be loaded into R, to provide extra functionality. For example you might load a package for formatting data, or for making maps. 

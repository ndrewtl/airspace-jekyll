...
- R has a very active and helpful online community, normally a quick google is all it takes to find somebody who has fixed the problem you're having. 
...
The next few lines of code usually load the packages you are using for you analysis. A package is a bundle of commands that can be loaded into R, to provide extra functionality. For example you might load a package for conducting mixed effects models, or for plotting map data. 

...
__In random effects models__, the assumption is different. Instead of estimating a single average effect size (e.g. males respond x amount and females respond y amount), random effects models assume there will be true variation around the average. The sources of this variation can be explained using the random effects i.e. there may be variance within data points that represent males, based on their location, habitat, species etc.
...
<center> <img src="{{ site.baseurl }}/img/mcmcglmm/mcmc3random.png" alt="Img" style="width: 400px;"/> </center>
...
Including species as a random effect will tell us how much variance there is between species, but it won’t estimate an average response for each one. To this effect, you might choose to include something as a random effect when there are __lots of categories__ (in this case there are lots of species) in your variable.
...
<center> <img src="{{ site.baseurl }}/img/mcmcglmm/Image 9.PNG" alt="Img" style="width: 600px;"/> </center>
...
__Note:__ I have increased the number of iterations as 60000 to improve mixing and effect sample sizes.
...
<center> <img src="{{ site.baseurl }}/img/mcmcglmm/Image 12.PNG" alt="Img" style="width: 600px;"/> </center>
...
<center> <img src="{{ site.baseurl }}/img/mcmcglmm/Image 14.PNG" alt="Img" style="width: 600px;"/> </center>
...
__3.__	Run a basic random effects model. Save the BLUPS.
...
```r
names(randomblup) # identify which BLUPs belong to Species
randomblup[9:416] # there are a lot of species in this analysis!
```
...
__Note:__ you can also restructure the variance for your random effects and in this case you will need to update the effect's prior. Here is an example if we wanted to estimate the variance for each location for which we have data, although this might not be something you need to use for a meta-analysis, I just want to show you the code. There are 25 different locations:

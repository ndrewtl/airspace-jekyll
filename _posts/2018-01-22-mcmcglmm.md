...
Frequentist statistics considers the probability of observing the data conditional on a set of parameter values. This probability is equal to the frequency at which a particular set of data would be observed had the experiment been run (hypothetically) a very large number of times. For example, if I had a coin and asked what is the probability of flipping a head you would say 0.5. This would be the frequency of heads if you flipped the coin a large number of times, with any uncertainty being statistical. This is the basis of __Frequentist statistics__.
...
Bayesian statistics therefore considers the probability of a set of parameter values conditional on observing the data. This probability is characterising subjective (or epistemic) uncertainity about the true values.
...
This is a good schematic of Bayes' theorem. The output of a ````MCMCglmm```` model is a __posterior distribution__, which is a combination of your data, your prior knowledge, and the __[likelihood](https://www.youtube.com/watch?v=XepXtl9YKwc)__ function.
...
<center> <img src="{{ site.baseurl }}/img/mcmcglmm/mcmc6nu.PNG" alt="Img" style="width: 700px;"/> </center>

...
Read through this tutorial, then use the skills you have learned to convert the tutorial R script, [which you can find here](https://github.com/ourcodingclub/CC-2-RMarkdown/blob/master/RMarkdown_Tutorial.R), into a .Rmd document.

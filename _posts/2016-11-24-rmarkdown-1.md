...
Now download our [demo R script](https://github.com/ourcodingclub/CC-2-RMarkdown/blob/master/RMarkdown_Tutorial.R) and use the instructions below to help you convert this script into a coherent story.
...
Either in a small group or on your own, convert one of the three demo R scripts into a well commented and easy to follow R Markdown document, or R Markdown Notebook. The files (RMarkdown_Demo_1.R, RMarkdown_Demo_2.R, RMarkdown_Demo_3.R) can be found in [this github repository](https://github.com/ourcodingclub/CC-2-RMarkdown).

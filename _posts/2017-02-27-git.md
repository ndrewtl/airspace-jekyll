...
There are several excellent guides on version control using git that provide an in-depth introduction (e.g. <a href = "http://simon-m-mudd.github.io/NMDM_book/#_version_control_with_git">Prof Simon Mudd's Numeracy, Modelling and Data management guide</a> and this <a href = "https://swcarpentry.github.io/git-novice/">Software Carpentry guide</a>). You can also check out <a href = "https://github.com/BES2016Workshop/version-control">this guide on using git through the command line and through RStudio </a> from the British Ecological Society Version Control workshop. 

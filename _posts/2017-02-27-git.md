...
Go back to your repository on Github, where you can now see all of your files online.
...
3. If you are on a personal Windows machine, you can run Git using Git Bash, which can be installed when you installed Git.h
...
<p><a href="http://e3dtp.geos.ed.ac.uk/"><img src="img/dtp_for_cc.jpg" alt="Img"  style="width: 600px;"></a>

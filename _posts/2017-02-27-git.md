...
__We also know that there might be problems with the newest updates of the Mac software and installing git and linking it with RStudio. The solutions appear to be very specific to the Mac version you have, so if the above code didn't work, a good starting point is googling "rstudio can't find git mac **your version**" and trying out the suggested solutions.__

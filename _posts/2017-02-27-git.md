...
4. If you are on a University of Edinburgh Windows machine you might be able to use the GeoSciences XRDP service and connect to a GeoSciences Linux server, __if you have access__. Instructions can be found on the <a href="https://www.ed.ac.uk/geosciences/intranet/it/linux-servers/xrdp" target="_blank">University website, here</a>. When you connect you can open a terminal by selecting the button marked in the screenshot below:

...
If your model has a lot of variables, you are also in danger of __overfitting__, meaning that you have many variables, but there simply is not enough variation in your dataset to account for including all of them. Overfitting can cast doubt over your model's output so think carefully about the structure of your model

...
To transform one date format into another you can use `format()` in conjunction with any of the date codes in the table above e.g.:

```r
format(milk$Month_date, format = "%Y-%B")
```

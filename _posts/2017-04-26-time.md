...
#### All the resources for this tutorial, including some helpful cheatsheets can be downloaded from <a href="https://github.com/ourcodingclub/CC-time-series" target="_blank">this github repository</a>. Before we start, clone and download the repo as a zipfile, then unzip it.
...
Now you know how to transform data in to the `Date` class, and how to create `character` class data from `Date` data. 

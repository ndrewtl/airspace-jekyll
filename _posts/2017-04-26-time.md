...
Now that we have identified the best forecast model, we can use this model to find out what milk production will be like in the year 2018! Use the code below to extract a predicted value for a given year from our forecast:

...
Choosing which model to use to forecast your data can be difficult. Let's first compare model forecasts of different ETS models visually by extracting forecast data from `forecast` objects:
